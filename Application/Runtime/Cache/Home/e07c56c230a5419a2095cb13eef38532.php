...
<form action="<?php echo U('Content/add');?>" method="POST">
		<div class="wenjian b">
      ...
      <div class="col-md-8">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name='title' placeholder="请输入文章标题" required="required">
              </div>
               </div>
               <div class="col-md-4">
		...
		<div class="wenjian b">
		  ...
		  <div class="col-md-4">
				<div class="form-group">
					<label for="exampleInputEmail1">文章封面</label><span class="pull-right text-info">建议尺寸：460*260px</span>
					 <p><img src="/feiyu/Public/admin/img/tub.png" class="thumbnail litpic"></p>
		  ...
		  <div class="form-group">
		    ...
		    <input type="text" class="form-control" name='keywords' id="exampleInputEmail1" placeholder="请输入文章关键字">
		  </div>
		    <div class="form-group">
		    <label for="exampleInputEmail1">文章描述</label>
		    <textarea class="form-control" rows="3" name='description'  placeholder="请输入文章描述信息(若不填写，将自动抓取文章信息)"></textarea>
		  </div>
		</div>
		</div>
			...
			<textarea id="editor" placeholder="Balabala" autofocus name='body'  required="required"  class='weditor' style="height:800px;max-height:2500px;"></textarea>
		      </div>
              <div class="wenjian b">
