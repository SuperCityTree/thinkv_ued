            ...
            <div class="panel-heading" role="tab" id="headingOne">
              <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                  ...
                  <a href="/he/index.php/Home/Content/addset/cid/<?php echo ($catid); ?>/type/text" class="btn btn-warning pull-right" type="button" >新增文字类型</a><a  href="/he/index.php/Home/Content/addset/cid/<?php echo ($catid); ?>/type/img" class="btn btn-warning pull-right mr20" type="button" >新增图片类型</a>
    ...
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
      <ul class="list-group">
                    ...
                    <?php if(is_array($catset_list)): $i = 0; $__LIST__ = $catset_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="list-group-item catset"><i  class='tips' data-toggle="tooltip" data-placement="right" title="调用:<?php echo ($vo["value"]); ?>"><?php echo ($vo["name"]); ?></i><a href="" date='<?php echo ($vo["id"]); ?>'  class="tn btn-danger pull-right btn-xs pull-right ds">删除</a>
                        <a href="/he/index.php/Home/Content/editset/cid/<?php echo ($catid); ?>/id/<?php echo ($vo["id"]); ?>"  date='<?php echo ($vo["aid"]); ?>' date-key='<?php echo ($vo["info"]); ?>'  date-value='<?php echo ($vo["value"]); ?>'   class="tn btn-info pull-right btn-xs pull-right editsys mr20">编辑</a><span class='pull-right mr20'>
...
var aid=$(this).attr('date')
  ...
  $.ajax({
                cache: true,
                type: "POST",
                url:"/he/index.php/Home/content/delete_setcat/id/"+aid,
                async: false,
...
<div class="row" style="margin-left: 0px;">
  <h4>|<?php echo ($catinfo["catname"]); ?></h4>
                         ...
                         <div class="row">
                                        ...
                                        <?php if(!empty($news_list)): if(is_array($news_list)): $i = 0; $__LIST__ = $news_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-xs-6 col-lg-6 news_outer">
                                                                      <h3><?php echo ($vo["title"]); ?></h3>
                                                                      <div class="media_img">
                                                                     <?php if(!empty($vo["thumb"])): ?><img src="<?php echo ($vo["thumb"]); ?>">
                                                                          <?php else: ?>
                                                                           <img src="/he/Public/admin/img/nopic.png"><?php endif; ?>
                                                                      </div>
                                                                      <p> <a class="dodelete pull-left" link='/he/index.php/Home/Content/new_delete/id/<?php echo ($vo["id"]); ?>' role="button"><span class='glyphicon glyphicon-trash'></span></a><a class="btn btn-default pull-right " href="/he/index.php/Home/Content/edit/cid/<?php echo ($vo["catid"]); ?>/id/<?php echo ($vo["id"]); ?>" role="button">编辑</a><a class="btn btn-success pull-right  mr20" href="/he/index.php/Ue/Show/index/cid/<?php echo ($vo["catid"]); ?>/aid/<?php echo ($vo["id"]); ?>" target="new" role="button">前台预览</a></p>
                           ...
                           <p style="margin-top: 30px;"> <a class="btn btn-success pull-right  mr20" href="/he/index.php/Home/Content/add/cid/<?php echo ($catid); ?>" role="button">发布新文章</a></p>
