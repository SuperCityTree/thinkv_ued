            ...
            <div class="panel-heading" role="tab" id="headingOne">
              <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                  ...
                  <a href="/feiyu/index.php/Home/Content/addset/cid/<?php echo ($catid); ?>/type/text" class="btn btn-warning pull-right" type="button" >新增文字类型</a><a  href="/feiyu/index.php/Home/Content/addset/cid/<?php echo ($catid); ?>/type/img" class="btn btn-warning pull-right mr20" type="button" >新增图片类型</a>
    ...
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
      <ul class="list-group">
                    ...
                    <?php if(is_array($catset_list)): $i = 0; $__LIST__ = $catset_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="list-group-item catset"><i  class='tips' data-toggle="tooltip" data-placement="right" title="调用:<?php echo ($vo["value"]); ?>"><?php echo ($vo["name"]); ?></i><a href="" date='<?php echo ($vo["id"]); ?>'  class="tn btn-danger pull-right btn-xs pull-right ds">删除</a>
                        <a href="/feiyu/index.php/Home/Content/editset/cid/<?php echo ($catid); ?>/id/<?php echo ($vo["id"]); ?>"  date='<?php echo ($vo["aid"]); ?>' date-key='<?php echo ($vo["info"]); ?>'  date-value='<?php echo ($vo["value"]); ?>'   class="tn btn-info pull-right btn-xs pull-right editsys mr20">编辑</a><span class='pull-right mr20'>
...
var aid=$(this).attr('date')
  ...
  $.ajax({
                cache: true,
                type: "POST",
                url:"/feiyu/index.php/Home/content/delete_setcat/id/"+aid,
                async: false,
...
<div class="row" style="margin-left: 0px;">
  <h4>|<?php echo ($catinfo["catname"]); ?></h4>
                        ...
                        <div class="btn-group btn-group-justified subcat" role="group" aria-label="Justified button group">                                           
                         ...
                         <div class="row">
                                <?php if(is_array($list_hr)): $i = 0; $__LIST__ = $list_hr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hr): $mod = ($i % 2 );++$i;?><div class="col-xs-6 col-lg-6 news_outer">
                                      <h3><?php echo ($hr["title"]); ?></h3>   
                                      <div class="details fl">
                                        <p style='color:#327a00'><?php echo ($hr["salary"]); ?></p>
                                        <p><span class="pla" style="color:#8ed3ff">工作地点:</span> <?php echo ($hr["address"]); ?></p>
                                        <p><?php echo ($hr["text"]); ?></p>
                                        <p>发布时间: <?php echo (date('Y-m-d',$hr["inputtime"])); ?></p>
                                      </div>

                                      <p> <a class="dodelete pull-left" link='/feiyu/index.php/Home/Content/hr_delete/id/<?php echo ($hr["id"]); ?>' role="button"><span class='glyphicon glyphicon-trash'></span></a><a class="btn btn-default pull-right " href="/feiyu/index.php/Home/Content/edit_hr/id/<?php echo ($hr["id"]); ?>/cid/<?php echo ($hr["catid"]); ?>" role="button">编辑</a>
                                    <a class="btn btn-success pull-right  mr20" href="/feiyu/index.php/Ue/Show/index/cid/<?php echo ($hr["catid"]); ?>/aid/<?php echo ($hr["id"]); ?>" target="new" role="button">前台预览</a></p>
                                    </div><!--/.col-xs-6.col-lg-4--><?php endforeach; endif; else: echo "" ;endif; ?>
                                       <?php echo ($page); ?>
                          </div>
                           <p> <a class="btn btn-success pull-right  mr20" href="/feiyu/index.php/Home/Content/add_hr/cid/<?php echo ($catid); ?>" role="button">添加新的职位信息</a>
                          </p>
