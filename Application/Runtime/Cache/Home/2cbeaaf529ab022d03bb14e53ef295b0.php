...
<link rel="stylesheet" type="text/css" href="/he/Public/admin/editor/css/simditor.css" />
...
<form action="<?php echo U('content/editset');?>" method="POST">
        ...
        <label for="recipient-name" class="control-label">所属设置组:</label>
		  ...
		  <div class="form-group">
		    ...
		    <input type="text" class="form-control" name='name' id="exampleInputEmail1" placeholder="请输入标题" value="<?php echo ($info["name"]); ?>">
		  </div>
      <div class="form-group">
        <label for="exampleInputEmail1">图片链接</label>
        <input type="text" class="form-control" name='img_link' id="exampleInputEmail1" placeholder="请输入链接" value="<?php echo ($info["img_link"]); ?>">
      </div>
    ...
    <div class="form-group" style="display: none"><?php endif; ?>
                ...
                <input type="text" class="form-control" name='value' required="required"  id="exampleInputEmail1" placeholder="请输入调用符 英文字符" value='<?php echo ($info["value"]); ?>'>
              </div>
               <div class="wenjian b">
              <div class="form-group">
...
<div class="clear-fix"></div>
                  ...
                  <input type="hidden" value="<?php echo ($info["id"]); ?>" name='id'></input>
...
<script type="text/javascript" src="/he/Public/admin/js/jquery.dragsort-0.5.2.min.js"></script>
