...
<link rel="stylesheet" href="/thinkv/Public/admin/css/jquery.fileupload.css">
<link rel="stylesheet" href="/thinkv/Public/admin/css/toolkit.css">
<link rel="stylesheet" type="text/css" href="/thinkv/Public/admin/weditor/css/wangEditor.min.css" />
<link href="/thinkv/Public/admin/css/bootstrap-datetimepicker.min.css" rel="stylesheet" media="screen">

<script src="http://cdn.bootcss.com/jquery/2.0.1/jquery.js"></script>
<script src="http://cdn.bootcss.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>
<script type="text/javascript" src="/thinkv/Public/admin/js/bootstrap-datetimepicker.js" charset="UTF-8"></script>
<script type="text/javascript" src="/thinkv/Public/admin/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>


<!-- 拖拽插件 -->
<!-- 拖拽插件 -->
<script type="text/javascript" src="/thinkv/Public/admin/js/jquery.dragsort-0.5.2.min.js"></script>
...
<form action="<?php echo U('Content/add_media');?>" method="POST">
		<div class="wenjian b">
      ...
      <div class="col-md-8">
              ...
              <div class="form-group">
                <label for="exampleInputEmail1">所属类目</label>
		...
		<div class="wenjian b">
		  ...
		  <div class="col-md-4">
				<div class="form-group">
					<label for="exampleInputEmail1">内容封面</label><span class="pull-right text-info">建议尺寸：460*260px</span>
					 <p><img src="/thinkv/Public/admin/img/tub.png" class="thumbnail litpic"></p>
          ...
          <div class="wenjian b">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-xs-4">
                                    <input type="text" class="form-control"name='filename[]'  placeholder="请输入文件描述">
                                      <input type="hidden" class="form-control" name='fileadd[]' value="2">
                                  </div>
                                </div>
			...
			<textarea id="editor" class='weditor'  placeholder="Balabala" autofocus name='content'  style="height:800px;max-height:2500px;"></textarea>
		      </div>
              <div class="wenjian b">
...
<script type="text/javascript" src="/thinkv/Public/admin/weditor/js/wangEditor.min.js"></script>
<script type="text/javascript">
...
<!-- The File Upload image preview & resize plugin -->
<script src="/thinkv/Public/admin/js/jquery.fileupload-video.js"></script>
<!-- The File Upload image preview & resize plugin -->
<script src="/thinkv/Public/admin/js/jquery.fileupload-audio.js"></script>
<!-- The File Upload image preview & resize plugin -->
<script src="/thinkv/Public/admin/js/jquery.fileupload-other.js"></script>
...
<script type="text/javascript">
  ...
  $(function () {
    ...
    $('#fileupload_meida').fileupload({
        ...
        dataType: 'json',
        autoUpload: false,
        acceptFileTypes: /(\.|\/)(gif|jpe?g|png|mp4|flv|mov|f4v|)$/i,
        maxFileSize: 1524288800,
        // Enable image resizing, except for Android and Opera,
        // which actually support image resizing, but fail to
        // send Blob objects via XHR requests:
        disableImageResize: /Android(?!.*Chrome)|Opera/
